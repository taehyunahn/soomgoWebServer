...
$sql = "INSERT INTO board (writerSeq, moimSeq, title, content) 
VALUES ('$userSeq', '$moimSeq', '$title', '$content')";
// mysqli_query($conn, $sql);

if ($conn->query($sql) === TRUE) {
$boardSeq = mysqli_insert_id($conn); // 방금 생성한 데이터의 고유값(seq)을 변수에 담는다. -> 모임의 고유값
